...
class FrontendController extends Controller
{
    ...
    public function productDetails($slug)
    {
        ...
        // $relatedProducts = Product::where('subsubcategory_id', $cat_id)->where('id', '!=', $product->id)->orderBy('id', 'DESC')->get();
        ...
        return view('frontend.product.product_details', compact('product', 'multiImg', 'categories', 'new_products', 'product_color_en', 'product_size_en', 'relatedProducts'));
    }
    ...
    {
        $products = Product::where('status', 1)->where('is_featured', 1)->paginate(10);
