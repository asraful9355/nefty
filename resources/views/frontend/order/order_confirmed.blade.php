			                                    ...
			                                    <div class="col-lg-4 col-md-6">
			                                        <div class="invoice-number">
			                                            ...
			                                            <p class="invoice-addr-1 text-capitalize">
			                                                ...
			                                                <strong title="Phone">Phone:</strong> {{ get_setting('phone')->value ?? 'Null'}}<br>
			                                                <strong title="Email">Email: </strong>{{ get_setting('email')->value ?? 'Null'}}<br>
			                                            </p>
			                                        </div>
			                                    </div>
			                                    <div class="col-lg-4 col-md-6">
			                                        <div class="invoice-number">
			                                            ...
			                                            <p class="invoice-addr-1 text-capitalize">
			                                                ...
			                                                <strong title="Phone">Phone:</strong> {{ $order->user->phone ?? 'NULL' }}<br>
			                                                <strong title="Email">Email: </strong>{{ $order->user->email }}<br>
			                                            </p>
			                                        </div>
			                                    </div>
			                                    <div class="col-lg-4 col-md-6">
			                                    ...
			                                    <table class="table table-striped invoice-table">
			                                        ...
			                                        <tbody>
		                                                ...
		                                                <tr>
		                                                    ...
		                                                    <td class="text-center">{{$order_detail->
		                                                    qty ?? 'NULL'}}</td>
		                                                    <td class="text-right">৳{{ $order_detail->price ?? 'Null' }} * {{ $order_detail->qty}}</td>
		                                                </tr>
		                                                @endforeach
		                                                <tr>
