                ...
                <div class="container">
                    <div class="page-breadcrumb d-flex align-items-center">
                        @if (session()->get('language') == 'bangla')
                            <h3 class="breadcrumb-title pe-3">হট ডেলস প্রোডাক্ট</h3>
                        @else
                            <h3 class="breadcrumb-title pe-3">Hot Deals</h3>
                        @endif
                        <div class="ms-auto">
                            <nav aria-label="breadcrumb">
                                @if (session()->get('language') == 'bangla')
                                    <ol class="breadcrumb mb-0 p-0">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">হট ডেলস প্রোডাক্ট</li>
                                    </ol>
                                @else
                                    <ol class="breadcrumb mb-0 p-0">
                                        <li class="breadcrumb-item"><a href="{{ route('home') }}"><i
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Hot Deals Product</li>
                                    </ol>
                                @endif
                            </nav>
                        </div>
