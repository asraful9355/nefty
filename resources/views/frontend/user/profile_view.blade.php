                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="card shadow-none mb-0">
                                        <div class="card-body">
                                            <form class="row g-3" method="post" action="{{ route('user.profile.store') }}"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <div class="col-sm-6">
                                                    <label for="inputFirstName" class="form-label">Name</label>
                                                    <input type="text" name="name" class="form-control"
                                                        id="inputFirstName" placeholder="Write Name"
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" name="username" class="form-control"
                                                        id="inputLastName" placeholder="Write UserName"
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="email" name="email" class="form-control"
                                                        id="inputEmailAddress" placeholder="Write Email"
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="number" name="phone" class="form-control" id="phone"
                                                        placeholder="Write Number" value="{{ $adminData->phone }}">
                                                    @error('phone')
                                                        <span class="text-danger"
                                                            style="font-weight: bold;">{{ $message }}</span>
                                                    @enderror
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" name="address" class="form-control" id="address"
                                                        placeholder="Write Address" value="{{ $adminData->address }}">
                                                    @error('address')
                                                        <span class="text-danger"
                                                            style="font-weight: bold;">{{ $message }}</span>
                                                    @enderror
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" name="facebook" class="form-control"
                                                        id="facebook" placeholder="Write facebook link"
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" name="twitter" class="form-control"
                                                        id="twitter" placeholder="Write twitter link"
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" name="linkedin" class="form-control"
                                                        id="linkedin" placeholder="Write linkedin link"
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" name="whatsapp" class="form-control"
                                                        id="whatsapp" placeholder="Write whatsapp link"
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" name="youtube" class="form-control"
                                                        id="youtube" placeholder="Write youtube link"
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" name="website" class="form-control"
                                                        id="website" placeholder="Write website link"
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-sm-12 text-secondary">
                                                        <img id="showImage" name="photo"
                                                            src="{{ !empty($adminData->photo) ? url('upload/user_images/' . $adminData->photo) : url('upload/no_image.jpg') }}"
                                                            alt="User" style="width:80px; height: 80px;">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 text-secondary">
                                                    <input type="submit" class="btn btn-light btn-ecomm"
