                                    ...
                                    <div class="card shadow-none mb-0">
                                        <div class="card-body">
                                            <a data-bs-toggle="modal" data-bs-target="#address"
                                                class="btn btn-success btn-sm" style="float: right;">Create New Address</a>
                                            <!-- Modal -->
                                            <div class="modal fade" id="address" data-bs-backdrop="static"
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-lg-6">
                                                                        <label for="division_id"
                                                                            class="fw-bold text-black col-form-label">
                                                                            Division <span
                                                                    ...
                                                                    <div class="form-group col-lg-6">
                                                                        <label for="address"
                                                                            class="fw-bold text-black col-form-label">Address
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-lg-6 mb-3">
                                                    <div class="card mb-lg-0 position-relative">
                                                        <div class="card-body">
                                                            <p class="bg-danger"
                                                                style="position:absolute;bottom: 7px;right: 11px;padding: 4px 10px;font-weight: 600;font-size: 14px;color: #fff;border-radius: 20px;">
                                                                Default</p>
                                                            <div class="dropdown"
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item" href="#">Make This
                                                                        Default</a>
