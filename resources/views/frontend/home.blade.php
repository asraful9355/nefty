					...
					<div class="row d-flex align-items-center">
						<div class="col d-none d-lg-flex justify-content-center">
							<div class="">
								...
								<div class="">
									<a class="btn btn-light btn-ecomm" href="{{ $slider->slider_url}}">Shop Now <i class='bx bx-chevron-right'></i>
									</a>
								</div>
							</div>
						</div>
						<div class="col">
							<img src="{{asset($slider->slider_img) }}" class="img-fluid" alt="...">
						</div>
					</div>
				</div>
				@endforeach
		                ...
		                <div class="item">
		                    <div class="card rounded-0 product-card">
								...
								<a href="{{ route('product.details',$product->slug) }}">
									<img src="{{ asset($product->product_thumbnail) }}" width="261" height="196" class="card-img-top" alt="...">
								</a>
								@else
		...
		<section class="py-4">
		    <div class="container">
		        <div class="d-flex align-items-center">
		            ...
		            <a href="{{ route('hot_deals.all') }}" class="btn btn-light ms-auto rounded-0">View All<i class='bx bx-chevron-right'></i></a>
		        </div>
		        <hr/>
		        <div class="product-grid">
		            <div class="new-arrivals owl-carousel owl-theme">
		            ...
		            <div class="latest-news owl-carousel owl-theme">
		                <div class="item">
		                    <div class="card rounded-0 product-card border">
		                        ...
		                        <a href="javascript:;">
		                            <img src="{{ asset('frontend/assets/images/blogs/01.png') }}" class="card-img-top border-bottom bg-dark-1" alt="...">
		                        </a>
		                        <div class="card-body">
		                ...
		                <div class="item">
		                    <div class="card rounded-0 product-card border">
		                        ...
		                        <a href="javascript:;">
		                            <img src="{{ asset('frontend/assets/images/blogs/02.png') }}" class="card-img-top border-bottom bg-dark-1" alt="...">
		                        </a>
		                        <div class="card-body">
		                            <div class="news-title">
		                                <a href="javascript:;">
		                ...
		                <div class="item">
		                    <div class="card rounded-0 product-card border">
		                        ...
		                        <a href="javascript:;">
		                            <img src="{{ asset('frontend/assets/images/blogs/03.png') }}" class="card-img-top border-bottom bg-dark-1" alt="...">
		                        </a>
		                        <div class="card-body">
		                            <div class="news-title">
		                                <a href="javascript:;">
		                ...
		                <div class="item">
		                    <div class="card rounded-0 product-card border">
		                        ...
		                        <a href="javascript:;">
		                            <img src="{{ asset('frontend/assets/images/blogs/04.png') }}" class="card-img-top border-bottom bg-dark-1" alt="...">
		                        </a>
		                        <div class="card-body">
		                            <div class="news-title">
		                                <a href="javascript:;">
		                ...
		                <div class="item">
		                    <div class="card rounded-0 product-card border">
		                        ...
		                        <a href="javascript:;">
		                            <img src="{{ asset('frontend/assets/images/blogs/05.png') }}" class="card-img-top border-bottom bg-dark-1" alt="...">
		                        </a>
		                        <div class="card-body">
		                            <div class="news-title">
		                                <a href="javascript:;">
		                ...
		                <div class="item">
		                    <div class="card rounded-0 product-card border">
		                        ...
		                        <a href="javascript:;">
		                            <img src="{{ asset('frontend/assets/images/blogs/06.png') }}" class="card-img-top border-bottom bg-dark-1" alt="...">
		                        </a>
		                        <div class="card-body">
		                            <div class="news-title">
		                                <a href="javascript:;">
		                ...
		                <div class="featured-list mb-3">
		                    ...
		                    <div class="d-flex align-items-center">
		                        <div class="bottom-product-img">
		                            <a href="{{ route('product.details',$product->slug) }}">
										@if($product->product_thumbnail && $product->product_thumbnail != '' && $product->product_thumbnail != 'Null')
		                                	<img src="{{ asset($product->product_thumbnail) }}" width="100" height="75" alt="">
										@else
											<img src="{{ asset('upload/no_image.jpg') }}" width="100" height="75" alt="">
										@endif
		                            </a>
		                        </div>
		                        <div class="ms-0">
		                            ...
		                            @if ($product->discount_price > 0)
										<p class="mb-0 ml-3 text-white">
										 	...
										 	<span class="mb-0 text-decoration-line-through">৳ {{ $product->regular_price }}</span>
			                            </p>
		                            @else
		                            	<p class="mb-0 ml-3 text-white">
		                ...
		                <div class="new-arrivals-list mb-3">
		                    ...
		                    <div class="d-flex align-items-center">
		                        <div class="bottom-product-img">
		                            <a href="{{ route('product.details',$product->slug) }}">
										@if($product->product_thumbnail && $product->product_thumbnail != '' && $product->product_thumbnail != 'Null')
		                                	<img src="{{ asset($product->product_thumbnail) }}" width="100" alt="">
										@else
											<img src="{{ asset('upload/no_image.jpg') }}" width="100" alt="">
										@endif
		                            </a>
		                        </div>
		                        <div class="ms-0">
