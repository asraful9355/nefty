            ...
            <section class="py-3 border-bottom d-none d-md-flex">
                <div class="container">
                    <div class="page-breadcrumb d-flex align-items-center">
                        ...
                        <h3 class="breadcrumb-title pe-3">চাইল্ড ক্যাটাগরি প্রোডাক্ট</h3>
                        @else
                        <h3 class="breadcrumb-title pe-3">Product ChildCategories</h3>
                        @endif
                        <div class="ms-auto">
                            <nav aria-label="breadcrumb">
                                ...
                                <ol class="breadcrumb mb-0 p-0">
                                    <li class="breadcrumb-item"><a href="{{ route('home') }}"><i class="bx bx-home-alt"></i>হোম</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="/product/shop">দোকান</a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('product.category', $subsubcategory->category->slug) }}">
                                        {{ $subsubcategory->category->category_name_bn }}</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('product.subcategory', $subsubcategory->subcategory->slug) }}">
                                        {{ $subsubcategory->subcategory->subcategory_name_bn }}</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('product.childcategory', $subsubcategory->slug) }}">
                                        {{ $subsubcategory->sub_subcategory_name_bn }}</a></li>
                                </ol>
                                @else
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        <a href="{{ route('product.category', $subsubcategory->category->slug) }}">{{ $subsubcategory->category->category_name_en }}</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">
                                        <a href="{{ route('product.subcategory', $subsubcategory->subcategory->slug) }}">{{ $subsubcategory->subcategory->subcategory_name_en }}</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">
                                        <a href="{{ route('product.childcategory', $subsubcategory->slug) }}">{{ $subsubcategory->sub_subcategory_name_en }}</a></li>
                                </ol>
                                @endif
