								...
								<div class="card-body">
										...
										<ul class="list-unstyled mb-0 categories-list">
											...
											<li>
												<div class="form-check">
													...
													<label class="form-check-label" for="{{ $category->id }}">{{ $category->category_name_en ?? 'NULL'}}</label>
												</div>
											</li>
											@endforeach
										</ul>
									...
									<div class="product-brands">
										...
										<ul class="list-unstyled mb-0 categories-list">
											...
											<li>
												<div class="form-check">
													<input class="form-check-input" type="checkbox" value="" id="{{ $brand->id }}">
													<label class="form-check-label" for="{{ $brand->id }}">{{ $brand->brand_name_en ?? 'NULL'}}</label>
												</div>
											</li>
											@endforeach
										</ul>
