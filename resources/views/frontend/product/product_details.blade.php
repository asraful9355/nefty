							...
							<div class="col-12 col-lg-7">
								<div class="product-info-section p-3">
									...
									<div class="d-flex align-items-center mt-3 gap-2">
										<span class="text-white fs-5">৳{{ $amount }}</span>
				                            ...
				                            @elseif ($product->discount_type == 2)
				                             	<span class="save-price font-md color3 ml-15">{{ $discount }}% Off</span>
				                            @endif
                                        <h5 class="mb-0 text-decoration-line-through text-light-3">৳{{ $product->regular_price }}</h5>
									...
									<dl class="row mt-3">	<dt class="col-sm-3">Product Code:</dt>
										...
										<dd class="col-sm-9">{{ $product->category->category_name_en ?? 'NULL'}}</dd>
									...
									<div class="d-flex gap-2 mt-3">
										...
										<a style="cursor:pointer;" id="{{ $product->id }}" onclick="addToWishList(this.id)" class="btn btn-light btn-ecomm">
									...
									<div class="product-info">
										...
										<div class="product-action mt-2">
											...
											<div class="d-grid gap-2">
												<a href="javascript:;" class="btn btn-light btn-ecomm" onclick="addToCart()">
													<i class='bx bxs-cart-add'></i>Add to Cart
												</a>
