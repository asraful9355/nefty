    ...
    <div class="container">
        <nav class="navbar navbar-expand">
            <div class="shiping-title text-uppercase font-13 text-white d-none d-sm-flex">Need help? Call Us:
                <strong class="text-brand"> <a class="text-brand" href="tel:{{ get_setting('phone')->value ?? 'null' }}"><i class="fa fa-phone ms-1"></i> {{ get_setting('phone')->value ?? 'null'}}</a></strong></div>
            ...
            <div class="col-12 col-md order-4 order-md-2 advance_search">
                <form action="{{ route('product.search') }}" method="post">
                    ...
                    <div class="input-group flex-nowrap px-xl-4">
                        <input type="text" class="form-control w-100 search" placeholder="Search for Products" name="search" onfocus="search_result_show()" onblur="search_result_hide()">
                        <select name="searchCategory" id="searchCategory" class="form-select flex-shrink-0" aria-label="Default select example" style="width: 10.5rem;">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="javascript:;">
                                        <div class="cart-header">
                                            ...
                                            <p class="cart-header-clear ms-auto mb-0"><a href="{{ route('cart.show') }}">VIEW CART</a></p>
                                        </div>
                                    </a>
                                    ...
                                    <div class="shopping-cart-footer" id="miniCart_btn">
                                        ...
                                        <div class="d-flex border-top">
                                            <div class="d-grid p-3 text-center">
                                                <a href="{{ route('cart.show') }}" class="btn btn-light btn-ecomm">View Cart</a>
                                            </div>
                                            <div class="d-grid p-3" style="float: right;">
                                                <a href="{{ route('checkout') }}" class="btn btn-light btn-ecomm">CHECKOUT</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="shopping-cart-footer" id="miniCart_empty_btn">
                                        <div class="d-grid p-3 border-top">
                                            <a  href="{{ route('home')}}" class="btn btn-light btn-ecomm">Continue Shopping</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="/product/shop" class="nav-link">
                        @if(session()->get('language') == 'bangla') দোকান @else Shop @endif 
                    </a>
                </li>
                @php
                    $categories = App\Models\Category::orderBy('category_name_en', 'ASC')->get();
                ...
                <li class="nav-item dropdown">
                  ...
                  @endif<i class='bx bx-chevron-down'></i></a>
                    <div class="dropdown-menu dropdown-large-menu">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <a href="{{ route('product.subcategory', $subcategory->slug) }}" class="large-menu-title">
                                @if(session()->get('language') == 'bangla')
                                ...
                                <ul class="">
                                    <li>
                                    <a href="{{ route('product.childcategory', $subsubcategory->slug) }}">
                                      @if(session()->get('language') == 'bangla')
