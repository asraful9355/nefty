                    ...
                    <div class="shadow-lg rounded" style="background-color:#005f7d;">
                        <div class="p-3 border-bottom d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('compare.reset') }}" style="text-decoration: none;"
                                class="btn btn-danger btn-sm fw-600">Reset Compare List</a>
                        </div>
                                                ...
                                                @foreach (Session::get('compare') as $key => $item)
                                                    <th scope="col" style="width:28%" class="font-weight-bold">
                                                        <a class="text-reset fs-15"
                                                            href="{{ route('product.details', \App\Models\Product::find($item)->slug) }}">{{ \App\Models\Product::find($item)->name_en }}</a>
                                                    </th>
                                                @endforeach
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                ...
                                                @foreach (Session::get('compare') as $key => $item)
                                                    <td>
                                                        <img loading="lazy"
                                                            src="{{ asset(\App\Models\Product::find($item)->product_thumbnail) }}"
                                                            alt="Product Image" class="img-fluid py-4">
                                                    </td>
                                                @endforeach
                                            </tr>
                                            <tr>
