											...
											<div class="form-body">
												<form class="row g-3" action="{{ route('checkout.payment') }}" method="post">
													...
													<div class="col-md-6">
														...
														<input type="text" name="name" value="{{ Auth::user()->name ?? '' }}" class="form-control rounded-0">
													</div>
													<div class="col-md-6">
														<label class="form-label">Phone:</label>
														<input type="text" name="phone" value="{{ Auth::user()->phone ?? '' }}" class="form-control rounded-0">
													</div>
													<div class="col-md-6">
														<label class="form-label">Email:</label>
														<input type="email" name="email" value="{{ Auth::user()->email ?? '' }}" class="form-control rounded-0">
													</div>
													<div class="col-md-6">
														<label class="form-label" for="division_id">Division:</label>
														<select  name="division_id" id="division_id" class="form-select rounded-0" required="">
													...
													<div class="col-md-6">
														...
														<select  name="district_id" id="distr" class="form-select rounded-0" required="">
															<option selected=""  value="">Select District</option>
														</select>
													</div>
													<div class="col-md-6">
														<label class="form-label" for="upazilla_id">Upazilla:</label>
														<select  name="upazilla_id" id="upazilla_id" class="form-select rounded-0" required="">
													...
													<div class="col-md-6">
														<div class="d-grid">
															<a href="{{ route('cart.show') }}" class="btn btn-light btn-ecomm">
											...
											<div class="card-body">
												...
												<div class="d-flex align-items-center">
													<a class="d-block flex-shrink-0" href="javascript:;">
														<img src="{{ asset($item->options->image)}}" width="75" alt="item">
													</a>
													<div class="ps-2">
														<h6 class="mb-1">
															<a href="#">
										...
										<div class="card rounded-0 border bg-transparent mb-0 shadow-none">
											<div class="card-body">
												...
												@else
													...
													<p class="mb-2">Subtotal:
														<span class="float-end" id="subtotal">৳{{ $cartTotal}}</span>
													</p>
													<!-- <p class="mb-2">Total Shipping:
														<span class="float-end" id="ship_charge">0.00<strong> Tk</strong></span>
													</p> -->
