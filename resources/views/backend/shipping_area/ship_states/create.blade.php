                        ...
                        <div class="row">
                           ...
                           <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="text" name="sub_subcategory_name_en" value="" id="sub_subcategory_name_bn" class="form-control" placeholder="Write subsubcategory name english">
                         ...
                         <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="text" name="sub_subcategory_name_bn" value="" id="sub_subcategory_name_bn" class="form-control" placeholder="Write subsubcategory name bangla">
