        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex">
                   ...
                   <span class="badge badge-success rounded-pill" style="font-size: 18px;"> {{ count($sliders) }} </span>
                </div>
                <div class="card-body">
                      ...
                      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                         ...
                         <tbody>
                            ...
                            <tr>
                               ...
                               <td> {{ $slide->title_bn ?? 'NULL' }} </td>
                               <td> {!! $slide->description_bn ?? 'NULL' !!} </td>
                               <td> {!! $slide->description_en ?? 'NULL' !!} </td>
                               <td>

                                @if($slide->status == 1)
                                <a href="{{ route('slider.in_active',['id'=>$slide->id]) }}" class="badge badge-success">Active</a>
                                @else
                                  <a href="{{ route('slider.active',['id'=>$slide->id]) }}" class="badge badge-danger">Disable</a>
                                @endif
                               </td>
                               <td>
                                  <a href="{{ route('slider.view',$slide->id) }}" class="btn btn-success btn-sm"><i class="fas fa-eye"></i></a>
