                    ...
                    <header class="card-header bg-success text-white">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4 col-md-4 ms-auto text-md-end">
                                ...
                                <a class="btn btn-danger print ms-2" href="#" onclick="window.print();"><i
                            ...
                            <div class="col-md-4">
                                <article class="icontext align-items-start">
                                    ...
                                    <div class="text">
                                        ...
                                        <p class="mb-1">
                                            City: {{ ucwords($order->upazilla->state_name ?? 'Null') }},
                                            <br />{{ ucwords($order->district->district_name ?? 'Null') }},<br />
                                            {{ ucwords($order->division->division_name ?? 'Null') }}
                                        </p>
                                    </div>
                                </article>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <select class="form-control select-active select2" name="division_id"
                                                ...
                                                <td>
                                                    ...
                                                    <select class="form-control select-active select2" name="district_id"
                                                ...
                                                <td>
                                                    ...
                                                    <select class="form-control select-active select2" name="upazilla_id"
                                                        ...
                                                        @foreach ($upazillas as $upazilla)
                                                            <option value="{{ $upazilla->id }}"
                                                                ...
                                                                {{ ucwords($upazilla->state_name) }}</option>
                                                        @endforeach
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="form-control select-active select2" name="payment_method"
                                                ...
                                                <td>
                                                    <select class="form-control select-active select2"
                                                        ...
                                                        <option value="cash"
                                                            @if ($payment_method == 'cash_on_delivery') selected @endif>Cash
                                                        </option>
                                                        <option value="bikash"
                                                            @if ($payment_method == 'bkash') selected @endif>Bikash
                                                        </option>
