...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
   ...
   <li class="nav-item">
      ...
      " aria-labelledby="headingPages" data-parent="#accordionSidebar">
         <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item {{ ($route == 'slider.index') ? 'active' : '' }}" href="{{ route('slider.index') }}">Manage Slider</a>
            <a class="collapse-item {{ ($route == 'slider.create') ? 'active' : '' }}" href="{{ route('slider.create') }}">Add Slider</a>
         </div>
      </div>
   ...
   <li class="nav-item">
      ...
      " aria-labelledby="headingPages" data-parent="#accordionSidebar">
         <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item {{ ($route == 'product.index') ? 'active' : '' }}" href="{{ route('product.index') }}">Manage Product</a>
            <a class="collapse-item {{ ($route == 'product.create') ? 'active' : '' }}" href="{{ route('product.create') }}">Product Add</a>
         </div>
      </div>
   </li>
   <li class="nav-item">
      ...
      " aria-labelledby="headingPages" data-parent="#accordionSidebar">
         <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item  {{ ($route == 'brand.index') ? 'active' : '' }}" href="{{ route('brand.index') }}">Manage Brand</a>
            <a class="collapse-item {{ ($route == 'brand.create') ? 'active' : '' }}" href="{{ route('brand.create') }}">Add Brand</a>
         </div>
      </div>
   </li>
   <li class="nav-item">
      <a class="nav-link collapsed" href="" data-toggle="collapse" data-target="#campaing"
         aria-expanded="true" aria-controls="real_estate">
      <i class="fas fa-fw fa-folder"></i>
      <span>Campaigns</span>
      </a>
      <div id="campaing" class="collapse
      ...
      " aria-labelledby="headingPages" data-parent="#accordionSidebar">
         <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item  {{ ($route == 'campaing.index') ? 'active' : '' }}" href="{{ route('campaing.index') }}">Manage Campaign</a>
            <a class="collapse-item {{ ($route == 'campaing.create') ? 'active' : '' }}" href="{{ route('campaing.create') }}">Add Campaign</a>
         </div>
      </div>
   </li>
   <li class="nav-item">
      ...
      " aria-labelledby="headingPages" data-parent="#accordionSidebar">
         <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item  {{ ($route == 'orders.index') ? 'active' : '' }}" href="{{ route('order.index') }}">All Orders</a>
         </div>
      </div>
   </li>
   <li class="nav-item">
   ...
   <li class="nav-item">
      ...
      {{ ($route == 'subsubcategory.create') ? 'show' : '' }}
       " aria-labelledby="headingPages" data-parent="#accordionSidebar">
         <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item {{ ($route == 'category.index') ? 'active' : '' }}" href="{{ route('category.index') }}">Manage Category</a>
            <a class="collapse-item {{ ($route == 'category.create') ? 'active' : '' }}" href="{{ route('category.create') }}">Add Category</a>
            <a class="collapse-item {{ ($route == 'subcategory.index') ? 'active' : '' }}" href="{{ route('subcategory.index') }}">Manage SubCategory</a>
            <a class="collapse-item {{ ($route == 'subcategory.create') ? 'active' : '' }}" href="{{ route('subcategory.create') }}">Add SubCategory</a>
            <a class="collapse-item {{ ($route == 'subsubcategory.index') ? 'active' : '' }}" href="{{ route('subsubcategory.index') }}">Manage SubSubCategory</a>
   ...
   <li class="nav-item">
      ...
      <div id="attribute" class="collapse
      {{ ($route == 'attribute.index') ? 'show' : '' }}
      {{ ($route == 'attribute.create') ? 'show' : '' }}
      " aria-labelledby="headingPages" data-parent="#accordionSidebar">
         <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item {{ ($route == 'attribute.index') ? 'active' : '' }}" href="{{ route('attribute.index') }}">Attribute List</a>
            <a class="collapse-item {{ ($route == 'attribute.create') ? 'active' : '' }}" href="{{ route('attribute.create') }}">Attribute Add</a>
         </div>
      </div>
   </li>
   ...
   <li class="nav-item">
     ...
     " aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item {{ ($route == 'pages.index') ? 'active' : '' }}" href="{{ route('pages.index') }}">Manage Pages</a>
        <a class="collapse-item {{ ($route == 'pages.create') ? 'active' : '' }}" href="{{ route('pages.create') }}">Add Padges</a>
        </div>
     </div>
   </li>
   <li class="nav-item">
   ...
   <li class="nav-item">
      ...
      " aria-labelledby="headingPages" data-parent="#accordionSidebar">
         <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item {{ ($route == 'blog.index') ? 'active' : '' }}" href="{{ route('blog.index') }}">Manage Blog</a>
            <a class="collapse-item {{ ($route == 'blog.create') ? 'active' : '' }}" href="{{ route('blog.create') }}">Add Blog</a>
         </div>
      </div>
   </li>
   ...
   <li class="nav-item">
      ...
      " aria-labelledby="headingPages" data-parent="#accordionSidebar">
         <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item {{ ($route == 'subscribe.index') ? 'active' : '' }}" href="{{ route('subscribe.index') }}">Manage Subscribe</a>
         </div>
      </div>
   </li>
   <li class="nav-item">
      ...
      <div id="vendors" class="collapse
      {{ ($route == 'vendor.index') ? 'show' : '' }}
      {{ ($route == 'vendor.create') ? 'show' : '' }}
      " aria-labelledby="headingPages" data-parent="#accordionSidebar">
         <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item {{ ($route == 'vendor.index') ? 'active' : '' }}" href="{{ route('vendor.index') }}">Manage Vendors</a>
            <a class="collapse-item {{ ($route == 'vendor.create') ? 'active' : '' }}" href="{{ route('vendor.create') }}">Add Vendors</a>
         </div>
      </div>
   </li>
   ...
   <li class="nav-item">
      ...
      " aria-labelledby="headingPages" data-parent="#accordionSidebar">
         <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item {{ ($route == 'coupon.index') ? 'active' : '' }}" href="{{ route('coupon.index') }}">Manage Coupons</a>
            <a class="collapse-item {{ ($route == 'coupon.create') ? 'active' : '' }}" href="{{ route('coupon.create') }}">Add Coupon</a>
         </div>
      </div>
   </li>
   ...
   <li class="nav-item">
      ...
      " aria-labelledby="headingPages" data-parent="#accordionSidebar">
         <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item {{ ($route == 'supplier.index') ? 'active' : '' }}" href="{{ route('supplier.index') }}">Manage Suppliers</a>
            <a class="collapse-item {{ ($route == 'supplier.create') ? 'active' : '' }}" href="{{ route('supplier.create') }}">Add Supplier</a>
         </div>
      </div>
   </li>
