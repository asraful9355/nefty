                            ...
                            <div class="card shadow-lg">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <label for="brand_id" class="col-form-label" style="font-weight: bold;">Brand:
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <label for="campaing_id" class="col-form-label"
                                                style="font-weight: bold;">Campaing: <span
                                                    class="badge bg-primary text-light">Optional</span></label>
                                            <div class="custom_select">
                                                <select class="form-control select-active w-100 form-select select-nice select2"
                                                    name="campaing_id" id="campaing_id">
                                                    <option selected="">---Select Campaing---</option>
                                                    @foreach ($campaings as $campaing)
                                                        <option value="{{ $campaing->id }}">{{ $campaing->name_en }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <label for="tags" class="col-form-label" style="font-weight: bold;">Tags:
                                                <span
                                                class="badge bg-primary text-light">Optional</span></label>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="custom_select cit-multi-select">
                                                <label for="choice_attributes" class="col-form-label"
                                                    ...
                                                    class="badge bg-primary text-light">Optional</span></label>
                                                <select class="form-control select-active select2"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-4">
                                            ...
                                            <input class="form-control" id="discount_price" type="number"
                                                name="discount_price" value="0" min="0"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <textarea id="short_description_en" name="short_description_en" rows="2" cols="2"
                                                class="form-control summernote" placeholder="Write Long Short Description English">{{ old('short_description_en') }}</textarea>
                                        </div>
                                        <div class="col-md-6 mb-4">
                                            <label for="short_description_bn" class="col-form-label"
                                                style="font-weight: bold;">Short Description (Bn):</label>
                                            <textarea id="short_description_bn" name="short_description_bn" id="long_descp_bn" rows="2" cols="2"
                                                class="form-control summernote" placeholder="Write Long Short Description Bangla">{{ old('short_description_bn') }}</textarea>
                                        </div>
                                        <!-- Description End -->
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        <div class="row">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="form-check-input me-2 cursor"
                                                    name="is_deals" id="is_deals" value="1">
                                        ...
                                        <div class="row">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="form-check-input me-2 cursor"
                                                    name="is_digital" id="is_digital" value="1">
