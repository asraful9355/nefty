        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <h1 class="h3 mb-2 text-gray-800 text-right">
                    <a href="{{ route('product.index') }}" class="btn btn-primary"><i class="fas fa-list"
                            aria-hidden="true"></i> Product List </a>
                </h1>
                <!-- DataTales Example -->
                <div class="row mt-3">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <label for="name_en" class="col-form-label" style="font-weight: bold;">Product
                                                Name (En): <span class="text-danger">
                                                    *</span></label>
                                            <input class="form-control" id="name_en" type="text" name="name_en"
                                                placeholder="Write product name english" required=""
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <label for="name_bn" class="col-form-label" style="font-weight: bold;">Product
                                                Name (Bn):</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <label for="category_id" class="col-form-label"
                                                style="font-weight: bold;">Category:  <span class="text-danger">
                                                    *</span></label>
                                            <a style="background-color: #3BB77E; float: right; "class="btn btn-sm float-end"
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <label for="subcategory_id" class="col-form-label"
                                                style="font-weight: bold;">SubCategory: <span class="text-danger">
                                                    *</span></label>
                                            <a style="background-color: #3BB77E; float: right;"class="btn btn-sm float-end"
                                            ...
                                            <div class="custom_select">
                                                <select name="subcategory_id" id="subcategory_id"
                                                    class="form-control select2" aria-invalid="false">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <label for="subsubcategory_id" class="col-form-label"
                                                style="font-weight: bold;">Sub->SubCategory:  <span class="text-danger">
                                                    *</span></label>
                                            <a style="background-color: #3BB77E; float: right;"class="btn btn-sm float-end"
                                                ...
                                                <select name="subsubcategory_id" id="subsubcategory_id"
                                                    ...
                                                    @foreach ($subsubcategories as $subsubcategory)
                                                        <option value="{{ $subsubcategory->id }}"
                                                            ...
                                                            {{ $subsubcategory->sub_subcategory_name_en }}</option>
                                                    @endforeach
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <label for="brand_id" class="col-form-label"
                                                style="font-weight: bold;">Brand: <span class="text-danger">
                                                    *</span></label>
                                            <a style="background-color: #3BB77E; float: right;" type="button"
                                                class="btn btn-sm float-end" id="closeModal1" data-toggle="modal"
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <label for="vendor_id" class="col-form-label"
                                                ...
                                                class="badge bg-primary text-light">Optional</span></label>
                                            <div class="custom_select">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <label for="supplier_id" class="col-form-label"
                                                style="font-weight: bold;">Supplier: <span
                                                class="badge bg-primary text-light">Optional</span></label>
                                            <div class="custom_select">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <label for="campaing_id" class="col-form-label"
                                                style="font-weight: bold;">Campaing: <span
                                                class="badge bg-primary text-light">Optional</span></label>
                                            <div class="custom_select">
                                                <select
                                                    class="form-control select-active w-100 form-select select-nice select2"
                                                    ...
                                                    @foreach ($campaings as $campaing)
                                                        <option value="{{ $campaing->id }}"
                                                            {{ $campaing->id == $product->campaing_id ? 'selected' : '' }}>
                                                            {{ $campaing->name_en }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <label for="tags" class="col-form-label"
                                                style="font-weight: bold;">Tags: <span
                                                class="badge bg-primary text-light">Optional</span></label>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="custom_select cit-multi-select">
                                                <label for="choice_attributes" class="col-form-label"
                                                    style="font-weight: bold;">Attributes: <span
                                                    class="badge bg-primary text-light">Optional</span></label>
                                                <select
                                                    class="form-control select-active w-100 form-select select-nice select2"
                                                            ...
                                                            @if (in_array($attribute->id, json_decode($product->attributes)))
                                                                ...
                                                                <div class="custom_select cit-multi-select mb-4">
                                                                    <label for="choice_attributes" class="col-form-label"
                                                                        ...
                                                                        :</label>
                                                                    <select
                                                                        class="form-control form-select js-example-basic-multiple select2"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12 mb-4">
                                            ...
                                            <input class="form-control" id="purchase_price" type="number"
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-4">
                                            ...
                                            <input class="form-control" id="regular_price" type="number"
                                                name="regular_price" placeholder="Write product regular price"
                                                min="0" value="{{ $product->regular_price }}">
                                            @error('regular_price')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="col-md-4 mb-4">
                                            ...
                                            <input class="form-control" id="discount_price" type="number"
                                                name="discount_price" placeholder="Write product discount price"
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <label for="product_qty" class="col-form-label"
                                                style="font-weight: bold;">Minimum Buy Quantity:</label>
                                            <input class="form-control" id="product_qty" type="number"
                                                name="minimum_buy_qty" placeholder="Write product qty" value="1"
                                                min="1" required value="{{ $product->minimum_buy_qty }}">
                                            @error('product_qty')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="col-md-6 mb-4">
                                            <label for="stock_qty" class="col-form-label"
                                                style="font-weight: bold;">Stock Quantity:</label>
                                            <input class="form-control" id="stock_qty" type="number" name="stock_qty"
                                                value="0" min="0" placeholder="Write product stock  qty"
                                            ...
                                            <table class="table table-active table-success table-bordered"
                                                ...
                                                <tbody>
                                                    @foreach ($product->stocks as $stock)
                                                        <tr>
                                                            <td>{{ $stock->varient }}
                                                                <input type="hidden" name="{{ $stock->id }}_variant"
                                                                    class="form-control" value="{{ $stock->varient }}"
                                                                    required>
                                                            </td>
                                                            <td>
                                                                <input type="text" name="{{ $stock->id }}_price"
                                                                    class="form-control vdp" value="{{ $stock->price }}"
                                                                    required>
                                                            </td>
                                                            <td>
                                                                <input type="text" name="{{ $stock->id }}_sku"
                                                                    class="form-control" required
                                                                    value="{{ $stock->sku }}">
                                                            </td>
                                                            <td>
                                                                <input type="text" name="{{ $stock->id }}_qty"
                                                                    class="form-control" value="{{ $stock->qty }}"
                                                                    required>
                                                            </td>
                                                            <td>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        <label for="product_thumbnail" class="col-form-label"
                                            style="font-weight: bold;">Product Image:</label>
                                        <input type="file" name="product_thumbnail" class="form-control"
                                            id="product_thumbnail" onChange="mainThamUrl(this)" required>
                                        <img src="{{ asset($product->product_thumbnail) }}" width="100"
                                            height="100" class="p-2" id="mainThmb">
                                    </div><br><br>
                                    <div class="col-md-12 mb-3">
                                        <div class="box-header mb-3 d-flex">
                                            <h4 class="box-title" style="font-weight: bold;">Product Gallery Image
                                        ...
                                        <div class="box bt-3 border-info">
                                            <div class="row row-sm">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <label for="multiImg" class="col-form-label"
                                                        style="font-weight: bold;">Add More:</label>
                                    ...
                                    <div class="mb-4">
                                        <div class="row">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="form-check-input me-2 cursor"
                                                    name="is_deals" id="is_deals"
                                                    {{ $product->is_deals == 1 ? 'checked' : '' }} value="1">
                                        ...
                                        <div class="row">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="form-check-input me-2 cursor"
                                                    name="is_digital" id="is_digital"
                                                    {{ $product->is_digital == 1 ? 'checked' : '' }} value="1">
                                        ...
                                        <div class="row">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="form-check-input me-2 cursor"
                                                    ...
                                                    {{ $product->is_featured == 1 ? 'checked' : '' }} value="1">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="title_en">Category Name (English): <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="category_name_en" value="" id="category_name_en"
                                        class="form-control" placeholder="Write category name english">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="title_bn">Category Name (Bangla) <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="category_name_bn" value="" id="category_name_bn"
                                        class="form-control" placeholder="Write category name bangla">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                ...
                <form method="post" action="#" enctype="multipart/form-data" id="subcategory_store">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="title_en">SubCategory Name (English): <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="subcategory_name_en" value=""
                                        id="subcategory_name_bn" class="form-control"
                                        placeholder="Write subcategory name english">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="title_bn">SubCategory Name (Bangla) <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="subcategory_name_bn" value=""
                                        id="subcategory_name_bn" class="form-control"
                                        placeholder="Write subcategory name bangla">
                ...
                <form method="post" action="#" enctype="multipart/form-data" id="subsubcategory_store">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="subcategory_id">Select SubCategory <span
                                            class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="title_en">SubSubCategory Name (English): <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="sub_subcategory_name_en" value=""
                                        id="sub_subcategory_name_bn" class="form-control"
                                        placeholder="Write subcategory name english">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="title_bn">SubSubCategory Name (Bangla) <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="sub_subcategory_name_bn" value=""
                                        id="sub_subcategory_name_bn" class="form-control"
                                        placeholder="Write subcategory name bangla">
                ...
                <form method="post" action="#" enctype="multipart/form-data" id="brand_store">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="brand_name_en" value="" id="brand_name_en"
                                        class="form-control" placeholder="Write Brand Title English">
                                    @error('brand_name_en')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="brand_name_bn">Brand Name (Bangla): <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="brand_name_bn" value="" id="brand_name_bn"
                                        class="form-control" placeholder="Write Brand Title Bangla">
                                    @error('brand_name_bn')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('select[name="category_id"]').on('change', function() {
                ...
                if (category_id) {
                    $.ajax({
                        url: "{{ url('admin/products/category-subcategory/ajax') }}/" +
                            category_id,
                        type: "GET",
                        dataType: "json",
                        success: function(data) {
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('select[name="subcategory_id"]').on('change', function() {
                ...
                if (category_id) {
                    $.ajax({
                        url: "{{ url('admin/products/subcategory-subsubcategory/ajax') }}/" +
                            category_id,
                        type: "GET",
                        dataType: "json",
                        success: function(data) {
                    ...
                    success: (data) => {
                        ...
                        $.each(data.categories, function(key, value) {
                            $('select[name="category_id"]').append('<option value="' +
                                value.id + '">' + value.category_name_en +
                                '</option>');
                        });
                    ...
                    success: (data) => {
                        ...
                        $.each(data.brands, function(key, value) {
                            $('select[name="brand_id"]').append('<option value="' +
                                value.id + '">' + value.brand_name_en + '</option>');
                        });
