                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <input type="text" name="name_en" value="" id="name_en" class="form-control" placeholder="Write name english">
                           @error('name_en')
                     ...
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <input type="text" name="name_bn" value="" id="name_bn" class="form-control" placeholder="Write name bangla">
                           @error('name_bn')
                           <span class="text-danger">{{ $message }}</span>
                           @enderror
                        </div>
                     ...
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <input type="text" name="title" value="" id="title" class="form-control" placeholder="Write Title ">
                           @error('title')
                           <span class="text-danger">{{ $message }}</span>
                           @enderror
                        </div>
